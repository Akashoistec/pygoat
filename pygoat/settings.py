...
"""
TEST_SECRET = "qwertyuipasdfghjkl1234567689qwerty"
import os
TOKEN = os.getenv("PAYMENT_GATEWAY_TOKEN")
...
SECRET_KEY = os.environ.get("DJANGO_SECRET_KEY", "dev-insecure-placeholder")
